 ...
 * CbTransSeq2016
 *
 * @ORM\Table(name="cb_trans_seq_2016", uniqueConstraints={@ORM\UniqueConstraint(name="tsq_tstamp_UNIQUE", columns={"tsq_tstamp"})})
 * @ORM\Entity
 */
class CbTransSeq2016
{
    /**
     * @var string
     *
