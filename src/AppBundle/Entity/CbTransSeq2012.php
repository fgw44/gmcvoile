 ...
 * CbTransSeq2012
 *
 * @ORM\Table(name="cb_trans_seq_2012", uniqueConstraints={@ORM\UniqueConstraint(name="tsq_tstamp_UNIQUE", columns={"tsq_tstamp"})})
 * @ORM\Entity
 */
class CbTransSeq2012
{
    /**
     * @var string
     *
